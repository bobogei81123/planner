...
export type ListTasksQuery = { __typename?: 'QueryRoot', tasks: Array<{ __typename?: 'Task', id: string, title: string, cost?: number | null, isCompleted: boolean, scheduledOn?: { __typename?: 'Epoch', type: EpochType, date: string } | null }> };
...
export type UpdateTaskMutation = { __typename?: 'MutationRoot', updateTask: { __typename?: 'Task', id: string, title: string, cost?: number | null, isCompleted: boolean } };
